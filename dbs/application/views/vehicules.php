			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                   ...
                   <div class="title_class2">
						<h1 class="cufonTitle" id="pageTitle" style="color:#000;">Véhicules Particuliers</h1><hr>
...
$my_query = new WP_Query('category_name=veh-par&posts_per_page=6');
...
while ($my_query->have_posts()) : $my_query->the_post(); ?>
	 <?php 
			...
			endwhile;
		if($numa!=1){echo '<br/><p style="font-weight:bold; font-size:15px; color:red;">Aucun résultat correspond à votre recherche!!</p>';} 
		} 
			else
			{ 
				while ($my_query->have_posts()) : $my_query->the_post(); ?>
