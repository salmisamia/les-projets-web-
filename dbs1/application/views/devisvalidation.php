...
<?php if($nom=='' || $prenom==''|| $vehicule=='' || $email==''){ echo "<span style='color:red; font-weight:bold;'>Vous devez remplir tout les champs !!!</span>";
...
<form action="<?=base_url();?>devisvalidation" style="width:350px; margin:auto;" id="devisform" method="POST" name="devisform">
 ...
 <label>Nom de véhicule *</label><br/><input name="vehicule" class="skinnedInput"><br/>
...
<?php } else{ echo "Votre demande a été bien envoyée !!!";} ?>
<!--webform -->
</div>
</div>
</div>
