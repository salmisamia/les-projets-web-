...
<?php if ($couleur=='') {
	echo'<h1 class="cufonTitle" id="pageTitle" style="color:#000;">Triés par prix</h1>';} else {echo '<h1 class="cufonTitle" id="pageTitle" style="color:#000;">Triés par couleur</h1>';}
 ?>
...
$my_query = new WP_Query('category_name=veh-uti&posts_per_page=6&oderby=get_post_meta( get_the_ID(), \'color\', false)&order=ASC');
...
$my_query = new WP_Query('category_name=veh-par&posts_per_page=6&oderby=get_post_meta( get_the_ID(), \'color\', false)&order=ASC');
